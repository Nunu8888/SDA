...
for index, platba in enumerate(platby):
    print(f"Vystavuji fakturu ID {index} od firmy s IČO {ICO} na částku {platba} ")

#Kdybych chtěl číslovat od 1
#    print(f"Vystavuji fakturu ID {(index)+1} od firmy s IČO {ICO} na částku {platba} ")